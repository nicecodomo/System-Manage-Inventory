...
// ดึงข้อมูลคำขอวัสดุที่ไม่อนุมัติ
$rejectedRequests = $requestManager->getRejectedRequests();
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">รายการเบิกวัสดุ (ไม่อนุมัติ)</h1>
            </div>
        </div>
        <div class="mb-3">
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body table-responsive">
                <table id="rejectedMaterialTable" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>ชื่อผู้ขอ</th>
...
$(document).ready(function() {
    $('#rejectedMaterialTable').DataTable({
        "responsive": true,
        "language": {
